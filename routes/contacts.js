...
router.post('/', contactsController.createContact); // contacts/create/???
...
router.put('/:id', contactsController.updateContact); // contacts/update/1234567890/???
...
router.delete('/:id', contactsController.deleteContact); // contacts/delete/1234567890/???
